...
export const RELOAD_EVENTS=[{at:.08,sound:'reload-open'},{at:.26,sound:'reload-clip'},{at:.43,sound:'reload-press'},{at:.62,sound:'reload-press'},{at:.78,sound:'reload-feed'},{at:.92,sound:'reload-close'}] as const;
